...
const NAV = [
  ...
  { href: '/admin/demandes', icon: '📨', label: 'Demandes' },
  { href: '/admin/appels',   icon: '📞', label: 'Appels' },
]
...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div style={{ display: 'flex', minHeight: '100vh', background: 'oklch(9% 0.012 250)', fontFamily: '-apple-system, BlinkMacSystemFont, system-ui, sans-serif' }}>
